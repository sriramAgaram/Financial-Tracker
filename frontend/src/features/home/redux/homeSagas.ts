...
export const addTransactionActions = createApiActions<{ expense_type_id: number, amount: number,date: string, transaction_type: string,notes: string }, void>('home/addTransaction');
...
const addTransactionApi =  async (data: { expense_type_id: number, amount: number,date: string, transaction_type: string,notes: string }) =>{
